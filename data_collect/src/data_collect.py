...
class DataCollectProcess:
    def __init__(self):
        ...
        # self.move_line_pub = rospy.Publisher('/move_line', Bool, queue_size = 10)
        ...
        rospy.Subscriber('/my_pose_temp', Int32, self.start_callback)
...
def main():
    ...
    rotate_robot = DataCollectProcess()
    # rotate_robot.run()
    rospy.spin()
