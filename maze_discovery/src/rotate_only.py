...
class RotateRobot:
    def __init__(self):
        rospy.init_node('rotate_only_node', anonymous=True)
        ...
        self.rotate_command_sub = rospy.Subscriber('/rotate_only', Int32, self.rotate_command_callback)

        self.pid_controller1 = PIDController(3, 0, 1)
        self.pid_controller2 = PIDController(2, 0, 0.5)  # Adjust the PID gains as needed
        ...
        self.my_pose = 0
        self.pose_pub = rospy.Publisher('/my_pose_temp', Int32, queue_size=10)
    ...
    def clamp_rotation_speed(self, speed):
        max_angular_speed = rospy.get_param('/jetbot/max_angular_speed', 1.5)
